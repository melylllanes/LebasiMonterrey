...
<body>
    <header id="header">
        ...
        <div class="card mx-auto mb-5 mt-4" style="max-width: 800px;">
            <img src="img/padecimientos/artritis.png" class="card-img-top rounded animate__animated animate__pulse" alt="Responsive image">
            <div class="card-body text-justify">
                <p class="card-text " style="font-size: 18px;">
                    La artritis reumatoide es una enfermedad crónica y degenerativa que se caracteriza por
                    provocar inflamación en la membrana sinovial (membrana que alimenta, protege y cubre los
                    cartílagos) de las articulaciones.<br></br>

                    La inflamación de esta membrana es la responsable del dolor, de la hinchazón claramente
                    visible y de la sensación de rigidez que los pacientes pueden sentir por las mañanas.
                    Se ha descubierto que las personas con AR presentan niveles bajos de selenio, mineral que
                    se encuentra en productos integrales (además de la semilla de ajonjolí y el ajo) y Lebasi.<br></br>

                    El selenio actúa como antioxidante. El calcio de Lebasi ayuda a la protección contra el
                    desgaste de huesos, también ayuda a regular el sistema inmunológico. Como resultado del
                    tratamiento de artritis infantil algunos niños carecen de ciertos minerales y vitaminas.
                    Las deficiencias más comunes son las de ácido fólico, vitaminas C, D, B6, B12 y E, calcio,
                    magnesio, selenio y zinc.<br></br>

                    Todos estos nutrimentos están contenidos en Lebasi y nos ayudaran a tener una buena salud
                    en las articulaciones.<br></br>
                </p>
            </div>
        </div>
