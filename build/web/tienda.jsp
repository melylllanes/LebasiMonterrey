            ...
            <div class="container-fluid padding-tittle" style=" max-width: 900px;">
                <div class="row ">
                    <div class="col-md-6 order-md-2 mb-4">
                        ...
                        <form class=" p-2" action="FormServlet" method="post">
                            <ul class="list-group mb-4">
                                <li class="list-group-item d-flex justify-content-between">
                                    <div class="pb-2">
                                        <h6 class="my-0">Número de Latas</h6>
                                    </div>
                        ...
                        <div>
                            <p class=" mt-2 ml-4 font-weight-bold text-justify" style="font-size: 12px">*Si vives fuera de Monterey y su zona metropolitina, <a href="https://api.whatsapp.com/send?phone=+528117602053">contáctenos</a>
                                para hacer la cotización de envio.</p>
                        </div>
