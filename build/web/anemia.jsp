...
<body>
    <header id="header">
        ...
        <div class="card mx-auto mb-5 mt-4" style="max-width: 800px;">
            <img src="img/padecimientos/anemia.png" class="card-img-top rounded animate__animated animate__pulse" alt="Responsive image">
            <div class="card-body text-justify">
                <p class="card-text " style="font-size: 18px;">
                    La anemia se define como una disminución en la cantidad de glóbulos rojos en la sangre,
                    o de su contenido de hemoglobina, por debajo de los parámetros normales según edad,
                    sexo y etapa de crecimiento.

                    Lebasi es un alimento 100% natural, libre de sustancias sintéticas, colorantes y
                    conservadores, el cual nos ayudara a combatir la anemia, y prevenirla otorgándonos lo que
                    es:<br></br>

                    <b>Vitamina B12:</b> Interviene en la formación de glóbulos rojos, es necesaria en la
                    transformación
                    de los ácidos grasos en energía y participa en el metabolismo del ácido fólico.<br></br>

                    <b>Ácido Fólico:</b> Es necesario para la formación de células sanguíneas, reduce el riesgo
                    de
                    aparición de defectos del tubo neural disminuye la ocurrencia de enfermedades
                    cardiovasculares,
                    ayuda a aumentar el apetito, en la anemia y estimula la formación de ácidos digestivos.<br></br>

                    <b>Hierro:</b> Es una parte importante de los glóbulos rojos. Sin este elemento, la sangre
                    no puede transportar oxígeno eficazmente.<br></br>

                    <b>Vitamina C:</b> Ayuda a la absorción del hierro en la sangre.<br></br>
                </p>
            </div>
        </div>
