            ...
            <div class="card">
                ...
                <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordionExample">
                    <div class="card-body">
                        ...
                        Costo de envió: $65 o $85 depende de zona.<br></br>
                        Si hay disponibilidad se puede entregar el mismo día.<br></br>
                        Contáctenos por medio de nuestro WhatsApp para agendar entrega a domicilio.
                        ...
                        Contáctenos por medio de nuestro WhatsApp para cotizar su envío por medio de paquetería.
                        <i>(De clic al icono de whatsApp que se encuentra abajo para comunicarte con
                            nosotros).</i><br></br>
                    </div>
                </div>
                ...
                <div class="card-header" id="headingTwo">
                    <h2 class="mb-0">
                        <button class="btn btn-link btn-block text-left collapsed" type="button" data-toggle="collapse"
                            ...
                            ¿Quién puede tomar Lebasi?
                        </button>
                    </h2>
                </div>
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionExample">
                    <div class="card-body">
                        Todas las personas en general, de niños a ancianos incluyendo mujeres embarazadas.
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionExample">
                    <div class="card-body">
                        Claro que sí, porque tendrá grandes beneficios para afrontar la demanda de nutrientes
                        que se requieren en este estado, no olvides que Lebasi es lo que tenemos más similar
            ...
            <div class="card">
                ...
                <div id="collapseFour" class="collapse" aria-labelledby="headingFour" data-parent="#accordionExample">
                    <div class="card-body">
                        ...
                        como malestares. Sin embargo, esto es lo que llamamos Crisis Curativa o Desintoxicación
                        y debe ser interpretado como una reacción benéfica a partir de la cual tendremos mejor salud.
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div id="collapseFive" class="collapse" aria-labelledby="headingFive" data-parent="#accordionExample">
                    <div class="card-body">
                        Sí, al equilibrar tu metabolismo, tu cuerpo estará en condiciones de eliminar la grasa
                        excedente,llegando con esto a tener la figura adecuada y lo mejor de todo, eliminando
                        la causa de sobrepeso no habrá rebote.
                    </div>
                </div>
            </div>
            <div class="card">
                ...
                <div id="collapseSix" class="collapse" aria-labelledby="headingSix" data-parent="#accordionExample">
                    <div class="card-body">
                        Sí Lebasi no contiene caseína que es la causa de muchas reacciones de intolerancia.
                        Además existen varios estudios médicos que demuestran que niños que son intolerantes
            ...
            <div class="card">
                ...
                <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven" data-parent="#accordionExample">
                    <div class="card-body">
                        ...
                        que al llegar al intestino se convierten en ácido láctico, que promueve el desarrollo de la
                        flora intestinal, esto significa que solo una pequeña parte de la lactosa entra al cuerpo.
                        Lebasi contiene solamente 28 calorías comparado a una manzana que tiene 70 calorías.
                    </div>
                </div>
            </div>
        </div>
