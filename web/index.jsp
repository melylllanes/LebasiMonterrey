        ...
        <header id="header">
            ...
            <div class="container-fluid padding-tittle">
                ...
                <div class="text-center">
                    <h2 class="font-weight-bold heading-style ">¿Qué es Lebasi?</h2>
                    <hr class="light1">
                </div>
            </div>
                    ...
                    <div class="col-md-8 ">
                        <div class="card-body text-justify m-2">
                            <p class="card-text " style="font-size: 18px;"> El Lactoserum Lebasi es un alimento Suizo 100%
                                ...
                                Es un alimento funcional, terapéutico o nutracéutico de fácil digestión y de alto
                                valor nutricional. Por su alto contenido en aminoácidos (19), vitaminas
                                (11) y minerales (11), es considerado un alimento hipernutricional que cubre los
                                requerimientos de proteínas en diversos estados como desnutrición, traumatismos,
                                infecciones, procedimientos quirúrgicos, cáncer, inmunodeficiencias y embarazo.</p>
                        </div>
                    </div>
                </div>
            </div>
